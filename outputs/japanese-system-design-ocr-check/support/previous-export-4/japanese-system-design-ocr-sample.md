...
drmd_schema: 1.0
drmd_rules: 1.0
document_id: doc_cc6918eca797cbab
source_format: xlsx
...
<!--drmd:block id=n_3c45b8603d3eca0b kind=image-text editability=annotation-only operations=replace-annotation constraints=original-unchanged-->
注文管理システム
MAIN MENU
ダッシュボード
注文検索
...
<!--drmd:document-end id=doc_cc6918eca797cbab partitions=5-->
