...
drmd_schema: 1.0
drmd_rules: 1.0
document_id: doc_88fa14319eda6092
source_format: xlsx
...
<!--drmd:block id=n_8004f61d243f9bcb kind=image-text editability=annotation-only operations=replace-annotation constraints=original-unchanged-->
注文管理システム
MAIN MENU
ダッシュボード
注文検索
...
<!--drmd:document-end id=doc_88fa14319eda6092 partitions=5-->
