...
> These command-line workflows are unsupported experiments in the v0.2.9 Public Beta. They are disabled unless you explicitly opt in; the desktop GUI accepts PDF input by default.
