...
> These command-line workflows are unsupported experiments in the current Public Beta. They are disabled unless you explicitly opt in; the desktop GUI accepts PDF input by default.
