...
> v0.2.6 Public Beta の利用者向けサポート範囲は、[日本語の対応状況](ja/supported-features.md) / [English support status](en/supported-features.md) を正本とします。
...
本文中の文字列がMarkdownのリンク・画像・参照リンク・参照定義の記法とたまたま一致していても(例: `[a](b)`、`![alt](x.png)`、`[id]: url`)、`[`と`]`をエスケープして元の文字列のまま表示し、意図しないリンクや画像として解釈しません。
