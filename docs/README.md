...
- [v0.1.3の対応機能](ja/supported-features.md)
...
- [v0.1.3 supported features](en/supported-features.md)
...
Reference documents may describe experimental capabilities implemented in code. They do not override the v0.1.3 user-facing support table.

## Benchmarks

- [Benchmark index](benchmarks/README.md)
- [AI document-format token-efficiency study](AI_DOCUMENT_FORMAT_TOKEN_BENCHMARK_2026-08-25.md)

## Maintainers

- [Maintainer documentation index](maintainers/README.md)
- [Publication scope](../release-docs/PUBLICATION_SCOPE.en.md)
- [Release checklist](../release-docs/RELEASE_CHECKLIST.en.md)
- [Brand guidelines](BRAND_DESIGN_GUIDELINES.md)
