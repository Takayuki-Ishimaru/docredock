...
DocRedock v0.2.7 Public Betaでは、デスクトップGUIでDOCX、XLSX、PPTX、PDFをローカルの**閲覧用Markdown**へ変換する操作をサポートします。
...
この文書が利用者向けサポート範囲の正本です。[v0.2.7リリースノート](../../release-docs/RELEASE_NOTES_v0.2.7.md)、[利用ガイド](user-guide.md)、[実験機能](experimental-features.md)、[セキュリティとプライバシー](security-and-privacy.md)も参照してください。
