...
/// emitted in hidden RTMD marker attributes and are also consumed by AI tools.
/// </summary>
public sealed record RtmdMarkdownBlockPolicy(
    string Editability,
...
public static class RtmdMarkdownEditPolicy
{
    private static readonly RtmdMarkdownBlockPolicy Protected =
    ...
    /// </summary>
    public static RtmdMarkdownBlockPolicy For(DocumentFormatKind format, DocumentNode node)
    {
