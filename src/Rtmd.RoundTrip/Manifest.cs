...
{
    [JsonPropertyName("name")] public string Name { get; init; } = "rtmd";
...
{
    [JsonPropertyName("format_adapter")] public ProviderInfo FormatAdapter { get; init; } = new("rtmd.adapter.none", "0.2.0", 1);
    [JsonPropertyName("markdown")] public ProviderInfo Markdown { get; init; } = new("rtmd.markdown.default", "0.2.0", 1);
    [JsonPropertyName("ocr")] public ProviderInfo Ocr { get; init; } = new("rtmd.ocr.none", "0.2.0", 1);
}
