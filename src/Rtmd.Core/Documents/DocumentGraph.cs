...
public sealed record TableNodeContent(IReadOnlyList<IReadOnlyList<string>> Rows) : NodeContent;
...
/// <summary>
/// The inline units RTMD can round-trip for rich Word paragraphs.  Line breaks and tabs
...
/// Hyperlinks, fields, revision markup, and drawing runs remain outside this contract.
/// </summary>
